...
public:
	...
	//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	// Added:		2009/10/20   10:18
	// comments:	Animation
	//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	int m_nAnimStep;
	int m_nAnimPos;
	enum {AnimationTimer = 12};
	...
	void Animate(int nStep) {m_nAnimPos += nStep; int nUpper,nLower;GetRange(nUpper,nLower);m_nAnimPos %= int(nUpper - nLower);}
	void ResetAnimation() {m_nAnimPos = 0;}

	//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	// Added:		2009/10/22   10:49
	// comments:	Borders
	//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	COLORREF m_clrBorderStart;
	COLORREF m_clrBorderEnd;
	//设置边框颜色，第一个颜色为进度条的颜色，第二个颜色为背景颜色
	//这样就会变现出没有边框的式样
	void SetBorderColor(COLORREF clr1,COLORREF clr2) { m_clrBorderStart = clr1; m_clrBorderEnd = clr2;}
	void DrawNCBorderH(int pos);
	void DrawNCBorderV(int pos);
	//CRect ConvertToReal(const CRect& rcBig, const CRect& rcDraw);
